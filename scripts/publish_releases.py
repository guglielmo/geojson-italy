...
redrawing its own lines, `source_attribute_change` is a published field changing with the
boundary untouched, and the `admin_*` values are the real events. Filter on it.
